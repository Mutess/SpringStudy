...
//		ApplicationContext app=new ClassPathXmlApplicationContext("app2.xml");
		StudentDAO dao=app.getBean("dao",StudentDAO.class);//이것도 형변환 (제네릭방식) //DL
		...
		while(true) {
			...
			case 4:{
				...
				String name=scan.next();
				System.out.println("국어 입럭 : ");
				int kor=scan.nextInt();
				System.out.println("영어 입럭 : ");
				int eng=scan.nextInt();
				System.out.println("수학 입럭 : ");
