   ...
   <main class="container clear">
    ...
    <div class="row">
    	<table class="table">
    		...
    		<tr v-if="filecount!=0">
    			<th width="20%" class="text-center info">첨부파일&nbsp;({{filecount}})개</th>
    			<td colspan="3">
    				<ul>
    		...
    		<tr>
    			<td colspan="4" class="text-right">
    				<a :href="'../databoard/update.do?no='+no" class="btn btn-xs btn btn-success">수정</a>
    				<a :href="'../databoard/delete.do?no='+no" class="btn btn-xs btn btn-info">삭제</a>
    				<a href="../databoard/list.do" class="btn btn-xs btn btn-warning">목록</a>
    			</td>
    		</tr>
    	</table>
    </div>
