...
<div class="wrapper row3">
  <main class="container clear"> 
    ...
    <table class="table">
    	<tr>
    		<td width="30%" class="text-center" rowspan="2">
    			<img :src="chef_info.poster" style="width: 100px;height: 100px;" class="img-circle">
    		</td>
    ...
    <%-- 
    	1. 가상돔 : 개발자가 HTML를 올리는 공간 => diff(실제 돔과 비교해서 => 변경
    		Vue(프레임워크 : 변경이 가능) / React (라이브러리:사용 (변경이 불가능)) ***
    ...
    <div class="content"> 
      <div id="gallery">
        <figure>
          <header class="heading inline right">
          ...
          <ul class="nospace clear" v-else="count!=0">
...
<script>
	new Vue({
		...
		data:{
			...
			startPage:0,
			endPage:0,
			chef:'${chef}', //recipecontroller에서 chef명을 보내줌
			fd:'all',
			count:0
		},
