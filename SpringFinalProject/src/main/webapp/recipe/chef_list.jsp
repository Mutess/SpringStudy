...
<div class="wrapper row3">
  <main class="container clear"> 
    ...
    <div class="content"> 
      <div id="gallery">
        <figure>
          <header class="heading">쉐프목록</header>
          <ul class="nospace clear">
            <li v-for="vo,index in chef_list" :class="index%4==0?'one_quarter first':'one_quarter'"><a :href="'../recipe/chef_find.do?chef='+vo.chef"><img :src="vo.poster" style="width: 100%;" :title="vo.chef"></a></li>
          </ul>
        </figure>
      </div>
