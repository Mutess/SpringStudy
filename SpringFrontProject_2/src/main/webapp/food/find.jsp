...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-3" v-for="vo in food_list">
			      <div class="thumbnail">
			        <a href="#">
			          <img :src="vo.poster" alt="Lights" style="width:100%"> <!-- 양방향 통신 -->
			          <div class="caption">
...
<script>
	new Vue({
		el:'.container-fluid',
		// react = state
		// React : 라이브러리(완제품),  VusJS : JavaScript 프레임워크(레고)
		// 멤버변수 => 화면이동전까지 유지
		data:{
			fd:'마포',
			food_list:[],
		...
		// 시작과 동시에 데이터를 읽어서 출력
		// Callback함수 => 시스템에 의해서 자동으로 호출되는 함수 => 생명주기
		...
		methods:{
			send:function(){
				// 스프링서버를 연결해서 => 필요한 데이터를 전송, 결과값을 받음
				// List =< Array []
