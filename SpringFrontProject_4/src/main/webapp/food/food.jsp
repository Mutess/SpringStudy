...
<body>
	...
	Vue.component('category1',{
		props:['cate1'],
		template:'<div>' //여기는 HTML작성
			+'<div class="col-md-3" v-for="vo in cate1">' //cate1이 값을 받음
			+'<div class="thumbnail">'
	...
	Vue.component('category2',{
		props:['cate2'],
		template:'<div>' //여기는 HTML작성
			+'<div class="col-md-4" v-for="vo in cate2">' //cate1이 값을 받음
			+'<div class="thumbnail">'
			+'  <img :src="vo.poster" alt="Lights" style="width:100%">'
			+'   <div class="caption">'
			+'     <p style="font-size: 9px;">{{vo.title }}</p>'
	...
	Vue.component('category3',{
		props:['cate3'],
		template:'<div>' //여기는 HTML작성
			+'<div class="col-md-3" v-for="vo in cate3">' //cate1이 값을 받음
			+'<div class="thumbnail">'
			+'  <img :src="vo.poster" alt="Lights" style="width:100%">'
			+'   <div class="caption">'
			+'     <p style="font-size: 9px;">{{vo.title }}</p>'
	...
	new Vue({ //여기서 값을 받고 Vue.component에 값을 전달
		el:'.container',
		data:{
			cate_list1:[],
			cate_list2:[],
